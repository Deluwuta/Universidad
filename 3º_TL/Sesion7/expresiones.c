...
{
       0,    48,    48,    49,    51,    52,    53,    54,    57,    59,
      61,    69,    77,    85,    93,   102,   107
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "SALIR", "ENTERO",
  "REAL", "ID", "'+'", "'-'", "'*'", "'/'", "'%'", "'^'", "menos", "'('",
...
{
     -15,     0,   -15,   -14,    -9,   -15,   -15,    -1,    19,    19,
     -15,    21,   -15,   -15,    19,   -15,    41,    19,    19,    19,
      19,    19,   -15,    31,   -15,     2,     2,   -15,   -15,   -15,
     -15
};
...
{
       2,     0,     1,     0,     0,     8,     9,     0,     0,     0,
       3,     0,     7,     5,     0,    15,     0,     0,     0,     0,
       0,     0,     4,     0,    16,    10,    11,    12,    13,    14,
       6
};
...
{
       2,     3,    12,     4,     5,     6,     7,    13,     8,    15,
      16,    19,    20,    21,     9,    23,    14,     0,    25,    26,
      27,    28,    29,     5,     6,     0,     0,     8,    17,    18,
      19,    20,    21,     9,     0,     0,     0,    22,    17,    18,
      19,    20,    21,     0,     0,     0,     0,    30,    17,    18,
      19,    20,    21,     0,     0,     0,    24
};

static const yytype_int8 yycheck[] =
{
       0,     1,    16,     3,     4,     5,     6,    16,     8,     8,
       9,     9,    10,    11,    14,    14,    17,    -1,    17,    18,
      19,    20,    21,     4,     5,    -1,    -1,     8,     7,     8,
       9,    10,    11,    14,    -1,    -1,    -1,    16,     7,     8,
       9,    10,    11,    -1,    -1,    -1,    -1,    16,     7,     8,
       9,    10,    11,    -1,    -1,    -1,    15
};
...
static const yytype_int8 yystos[] =
{
      ...
      20,    21,    16,    16,    17,    21,    21,     7,     8,     9,
      10,    11,    16,    21,    15,    21,    21,    21,    21,    21,
      16
};
...
#line 48 "expresiones.y"
                        {prompt();}
#line 1110 "expresiones.c"
    break;

  case 4: /* linea: expr '\n'  */
#line 51 "expresiones.y"
                        {cout << "El resultado es "<< (yyvsp[-1].c_expresion).valor <<endl; prompt();}
#line 1116 "expresiones.c"
    break;
...
#line 1122 "expresiones.c"
  ...
  case 6: /* linea: ID '=' expr '\n'  */
#line 53 "expresiones.y"
                        {cout << "A la variable " << (yyvsp[-3].var) << endl; prompt();}
