...
{
       0,    69,    69,    70,    73,    81,    87,    88,    91,    92,
      93,    94,    95,    96,    97,    98,    99,   100,   101,   102,
     103,   105,   109,   114,   122,   130,   138,   151,   164,   174,
     179,   184
};
#endif
...
#line 73 "expresiones.y"
                               {
        if (!errorSemantico) {
            cout << "Instrucción " << n_lineas << ": La variable " << (yyvsp[-3].var) << ", de tipo " << tipoValor((yyvsp[-1].c_expresion).esReal) << ", toma el valor " << (yyvsp[-1].c_expresion).valor << endl; 
        }
