...
{
       0,    66,    66,    67,    70,    78,    84,    85,    88,    89,
      90,    91,    92,    93,    94,    95,    96,    97,    98,    99,
     100,   102,   106,   111,   119,   127,   135,   148,   161,   171,
     176,   181
};
#endif
...
#line 70 "expresiones.y"
                               {
        if (!errorSemantico) {
            cout << "Instruccion " << n_lineas << ": La variable " << (yyvsp[-3].var) << ", de tipo " << tipoValor((yyvsp[-1].c_expresion).esReal) << ", toma el valor " << (yyvsp[-1].c_expresion).valor << endl; 
        }
...
#line 78 "expresiones.y"
                               {
        cout << "Instruccion " << n_lineas << ": ";
        cout << "La variable " << (yyvsp[-3].var) << ", de tipo logico, toma el valor " << valorLogico((yyvsp[-1].c_bool)) << endl;
        prompt();
    }
#line 1193 "expresiones.c"
    break;

  case 6: /* linea: SALIR '\n'  */
#line 84 "expresiones.y"
                { return(0); }
#line 1199 "expresiones.c"
    break;

  case 7: /* linea: error '\n'  */
#line 85 "expresiones.y"
                {yyerrok; prompt();}
#line 1205 "expresiones.c"
    break;
...
#line 135 "expresiones.y"
                     {
                              ...
                              if ((yyval.c_expresion).esReal) {
                                errorSemantico = true;
                                cout << "Error semantico en la instruccion " << n_lineas << ": se usa el operador div con operandos reales" << endl;
                              } 
                              else if ((yyvsp[0].c_expresion).valor == 0) {
                                errorSemantico = true;
                                cout << "Error semantico en la instruccion " << n_lineas << ": division por cero" << endl;
                              }
...
#line 148 "expresiones.y"
                           {
                              ...
                              if (!(yyval.c_expresion).esReal) {
                                errorSemantico = true;
                                cout << "Error semantico en la instruccion " << n_lineas << ": se usa el operador / con operandos enteros" << endl;
                              } 
                              else if ((yyvsp[0].c_expresion).valor == 0) {
                                errorSemantico = true;
                                cout << "Error semantico en la instruccion " << n_lineas << ": division por cero" << endl;
                              }
                              else (yyval.c_expresion).valor = (yyvsp[-2].c_expresion).valor / (yyvsp[0].c_expresion).valor; 
                           }
...
#line 161 "expresiones.y"
                           {
                              ...
                              if ((yyval.c_expresion).esReal){
                                errorSemantico = true;
                                cout << "Error semantico en la instruccion " << n_lineas << ": se usa el operador % con operandos reales" << endl;
                              } 
                              else 
                                (yyval.c_expresion).valor =int((yyvsp[-2].c_expresion).valor) % int((yyvsp[0].c_expresion).valor);
                           }
#line 1385 "expresiones.c"
    break;
...
#line 171 "expresiones.y"
                           {
                              (yyval.c_expresion).esReal = (yyvsp[-2].c_expresion).esReal || (yyvsp[0].c_expresion).esReal;
                              (yyval.c_expresion).valor =pow((yyvsp[-2].c_expresion).valor, (yyvsp[0].c_expresion).valor);
                           }
...
#line 1412 "expresiones.c"
    break;


#line 1416 "expresiones.c"
