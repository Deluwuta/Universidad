...
linea: ID ASIGNACION expr '\n' {
        if (!errorSemantico) {
            cout << "Instruccion " << n_lineas << ": La variable " << $1 << ", de tipo " << tipoValor($3.esReal) << ", toma el valor " << $3.valor << endl; 
        }
    ...
    |ID ASIGNACION logico '\n' {
        ...
        cout << "La variable " << $1 << ", de tipo logico, toma el valor " << valorLogico($3) << endl;
        prompt();
    }
